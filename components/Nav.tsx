        ...
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between items-center">
              ...
              <div className="hidden md:flex space-x-6 items-center">
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      item.current
                        ? 'text-red-600 font-semibold text-lg font-sans'
                        : 'text-orange-500 hover:text-red-600 text-lg font-sans',
                ...
                <Link
                  href="/login"
                  className="ml-4 bg-red-600 text-white px-4 py-2 rounded-md text-lg font-medium font-sans hover:bg-red-700"
                >
                  تسجيل الدخول
                </Link>
              </div>
          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <Link
                href="/login"
                className="  block mt-2 bg-red-600 text-white px-3 py-2 rounded-md text-lg  hover:bg-red-700"
              >
                تسجيل الدخول
              </Link>
            </div>
